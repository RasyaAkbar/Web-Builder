...
const PipelineTicket = ({
  ...
  return (
    ...
    > 
      {(provided, snapshot) => {
        {/* by default the component are fixed so it need some adjustment when we want to drag and drop */}
                ...
                <Card className="my-4 dark:bg-slate-900 bg-white shadow-none transition-all">
                  ...
                  <CardFooter className="m-0 p-2 border-t-[1px] border-muted-foreground/20 flex items-center justify-between">
                    ...
                    <span className="text-sm font-bold">
                      {!!ticket.value && // !! convert to bool
                        new Intl.NumberFormat(undefined, {
                          style: 'currency',
                          currency: 'USD',
                        }).format(+ticket.value)/* +ticket.value convert to number*/}
                    </span>
                  </CardFooter>
                  <DropdownMenuContent>
