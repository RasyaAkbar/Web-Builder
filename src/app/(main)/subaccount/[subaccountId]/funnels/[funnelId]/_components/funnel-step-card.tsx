...
const FunnelStepCard = ({ activePage, funnelPage, index }: Props) => {
  let portal = document.getElementById("blur-page"); // create section somewhere in the dom that you can insert element into and handle it relative to the portal
